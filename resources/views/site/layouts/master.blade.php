...
<head>
  ...
  <title>{{config('app.name')}} - Sistem Informasi Rekam Medis</title>
  ...
  <link href="{{asset('medilab/vendor/aos/aos.css')}}" rel="stylesheet">
  ...
  <!-- Main CSS File -->
  <link href="{{asset('medilab/css/main.css')}}" rel="stylesheet">
...
<body class="index-page">
  ...
  <script src="{{asset('medilab/vendor/aos/aos.js')}}"></script>
